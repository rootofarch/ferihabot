...
char ultrasonic_frameid[] = "/sarBravo/ultrasonic";
...
ros::Publisher ros_odom("/sarBravo/pose2d", &pose2d);

//ultrasonic sensors
sensor_msgs::Range range_msg;
ros::Publisher pub_range1("/sarBravo/ultrasonicRight", &range_msg);
ros::Publisher pub_range2("/sarBravo/ultrasonicLeft", &range_msg);

//cmd velocity
ros::Subscriber<geometry_msgs::Twist> sub("/sarBravo/cmd_vel", &cmd_vel_handle );
